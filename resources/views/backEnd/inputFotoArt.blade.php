              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Masukan Foto untuk Artikel yang Sesuai dan Tepat
                  </p>
                  <form class="forms-sample" method="POST" action="{{ route('admin.storeFotoArt') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" id="exampleInputName1" placeholder="Judul" name="idArtikel" value="{{ $showFoto->id_artikel }}">            
                    <div class="form-group">
