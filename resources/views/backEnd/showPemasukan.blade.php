      ...
      <div class="row">
        <div class="col-xs-12">          
          <div class="box">
            ...
            <div class="box-body">
              <a href="{{ route('PemasukanIn.create') }}" class="btn btn-block btn-primary btn-xs">+ Tambahkan</a>
                ...
                <tbody>                  
                 @foreach($pemasukan as $data)
                  <tr>
                    ...
                    <td>                    
                      <a href="{{ route('PemasukanIn.edit', $data->id) }}" class="btn btn-block btn-primary btn-xs">Edit</a> 
