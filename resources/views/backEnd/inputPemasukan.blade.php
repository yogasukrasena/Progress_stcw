            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="{{ route('PemasukanIn.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputCity1" placeholder="Sumber Dana" name="sumberDana">
                    </div>
                    <div class="form-group">
                      <label>Foto Bukti Pemasukan</label>
                      <input type="file" name="fotoPemasukan[]" class="file-upload-default" multiple="multiple">
