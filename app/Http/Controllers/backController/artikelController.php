...
class artikelController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backEnd.showArtikel', compact('showArtikel'));        
    }   
    ...
    public function create()
    {
        ...
        return view('backEnd.inputArtikel');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backEnd.editArtikel', compact('editArtikel')); 
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.showArtikel', compact('showArtikel'));
    }
    ...
    public function showFoto($id)
    {
        ...
        ->where('id_artikel',$id)->limit(1)->get();

        return view('backEnd.showFotoArt', compact('showFoto','idFoto')); 
    }
    ...
    public function inputFoto($id)
    {
        ...
        return view('backEnd.inputFotoArt', compact('showFoto')); 
    }
    ...
    public function FotoTrash()
    {
        ...
        return view('backEnd.showTrashFotoArt', compact('foto'));
    }
    ...
    public function ArtikelTrash()
    {
        ...
        return view('backEnd.showTrashArtikel', compact('artikel'));
    }
