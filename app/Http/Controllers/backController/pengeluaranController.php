...
class pengeluaranController extends Controller
{
   /**
    ...
    public function index()
    {
        ...
        return view('backEnd.showPengeluaran', compact('Pengeluaran'));
    ...
    {
        //
        return view('backEnd.inputPengeluaran');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backEnd.editPengeluaran', compact('Pengeluaran'));
    }
    ...
    public function showFotoOut($id)
    {
        ...
        return view('backEnd.showFotoOut', compact('foto','idFoto'));
    }
    ...
    public function inputFoto($id)
    {
        ...
        return view('backEnd.inputFotoOut', compact('showFoto')); 
    }
    ...
    public function FotoTrash()
    {
        ...
        return view('backEnd.showTrashFotoOut', compact('foto'));
    }
    ...
    public function PengeluaranTrash()
    {
        ...
        return view('backEnd.showTrashPengeluaran', compact('Pengeluaran'));
    }
