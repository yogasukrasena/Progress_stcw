...
class kegiatanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backEnd.showKegiatan', compact('showKegiatan'));
    }  
    ...
    public function create()
    {
        ...
        return view('backend.inputKegiatan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backEnd.editKegiatan', compact('editKegiatan'));
    }
    ...
    public function KegiatanTrash()
    {
        ...
        return view('backEnd.showTrashKegiatan', compact('kegiatan'));
    }
