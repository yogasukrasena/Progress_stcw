...
class pemasukanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backEnd.showPemasukan', compact('pemasukan'));
    ...
    {
        //
        return view('backEnd.inputPemasukan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backEnd.editPemasukan', compact('pemasukan'));
    }
    ...
    public function showFotoIn($id)
    {
        ...
        return view('backEnd.showFotoIn', compact('foto','idFoto'));
    }
    ...
    public function inputFoto($id)
    {
        ...
        return view('backEnd.inputFotoIn', compact('showFoto')); 
    }
    ...
    public function FotoTrash()
    {
        ...
        return view('backEnd.showTrashFotoIn', compact('foto'));
    }
    ...
    public function PemasukanTrash()
    {
        ...
        return view('backEnd.showTrashPemasukan', compact('Pemasukan'));
    }
